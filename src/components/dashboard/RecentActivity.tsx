            ...
            {activities.map((activity, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`flex items-center space-x-4 p-4 rounded-xl ${activity.bgColor} border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200 cursor-pointer group`}
                >
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${activity.bgColor} group-hover:scale-110 transition-transform duration-200`}>
                  ...
                  <div className="text-right">
                    <p className="text-xs text-gray-500 dark:text-gray-500">{getTimeAgo(activity.time)}</p>
                  </div>
                </motion.div>
              );
            })}
