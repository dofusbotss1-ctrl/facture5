...
export default function ProjectKanban({ projects, tasks, employees, onEditTask }: ProjectKanbanProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-purple-600">{filteredTasks.length}</p>
            <p className="text-sm text-gray-600">Tâches affichées</p>
          </div>
        </div>
      </div>
          ...
          {columns.map((column) => {
            ...
            return (
              <div key={column.id} className="space-y-4">
                ...
                {/* Column Content */}
                <div 
                  className={`min-h-96 ${column.color} border-2 border-dashed rounded-lg p-4 space-y-3`}
      ...
      {/* Légende */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h4 className="font-medium text-gray-900 mb-4">Légende</h4>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <h5 className="text-sm font-medium text-gray-700 mb-2">Priorités</h5>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">Basse priorité</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">Fichiers joints</span>
              </div>
              <div className="flex items-center space-x-2">
                <AlertTriangle className="w-4 h-4 text-red-600" />
                <span className="text-sm text-gray-600">Tâche en retard</span>
              </div>
            </div>
          </div>
          
          <div>
            <h5 className="text-sm font-medium text-gray-700 mb-2">Utilisation</h5>
