  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Rapports et Analytiques</h2>
          <p className="text-gray-600">Analyse détaillée de la performance des projets</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{totalEstimatedHours}</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">Analyse de Rentabilité</h3>
        ...
        {projectProfitability.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Aucune donnée de rentabilité disponible</p>
          </div>
        )}
      </div>
